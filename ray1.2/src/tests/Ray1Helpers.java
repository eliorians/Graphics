...
public class Ray1Helpers
{
    ...
    final static String testDirectory = "scenes/";
    ...
    public Ray1Helpers()
    {
    	...
    	ignoreFilePattern = Pattern.compile("^Ray1(?:Test[12]|Helpers)\\.java$");
    ...
    {
    	assertTrue("Failed to find a test in " + test, runTestsRecursive(testDirectory + test));
    }
     ...
     *            The image to change.
     */
    private static void writeRead(Image image, String fileName)
    {
        ...
        assertEquals("writeRead image is all black. " + fileName, allBlack, false);
    }
